                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div className="top_header_left">
                                <p>Special collection already available.<Link to="/shop">Check ...</Link></p>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div className="top_header_right">
                                {
                                    !status ?
                                        ...
                                        <ul className="right_list_fix">
                                            ...
                                            <li className="after_login"><img src={avater} alt="avater" /> {user.name || 'Mobeen Aslam'} <i className="fa fa-angle-down"></i>
