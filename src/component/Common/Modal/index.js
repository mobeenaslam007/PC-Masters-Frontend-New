                                ...
                                <div className="row">
                                    <div className="col-lg-5 col-md-6 col-sm-12 col-12">
                                        <div className="products_modal_sliders">
                                            <img src={props.data.image[0]} alt="img" />
                                        </div>
                                    </div>
                                    <div className="col-lg-7 col-md-6 col-sm-12 col-12">
                                        <div className="modal_product_content_one">
                                            ...
                                            <div className="reviews_rating">
                                                ...
                                                <span>({props.data.numReviews} Customer Reviews)</span>
                                            </div>
                                            <h4>PKR {props.data.price}.00 <del style={{fontWeight: 400, color: 'gray'}}>PKR {parseInt(props.data.price) + 17}.00</del> </h4>
