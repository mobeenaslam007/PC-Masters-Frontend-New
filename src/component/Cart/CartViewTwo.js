...
const CartViewTwo = () => {
    ...
    return (
        <>
            {carts?.length
                ?
                <section id="cart_area_two" className="ptb-50">
                                            ...
                                            <tbody>
                                                {carts?.map((data, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="product-price">PKR {data.price}.00</td>
                                                        ...
                                                        <td className="product_total">PKR {data.price * (data.quantity || 1)}.00</td>
                ...
                : <section id="empty_cart_area" className="ptb-50">
                    <div className="container">
                        <div className="row">
